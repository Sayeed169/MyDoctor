...
<body>
	...
	<?php if($status>-1):?>
		<h2>Appointment date<p style="color:blue"><?php echo $message;?></p></h2>
		<h2>Please Recharge Ammount 200/= Taka to Confirm Your Appointment</h2>
		<img src="https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcRHZZdlAhu3DUT2WEVWa0u6BjskyXKIxw-0kR8NWJFz2Ir0VkdedA">
	...
	<?php if($status<0):?>
		<h1>Appoint Date<p><?php echo $message?></p></h1>
		<p>Transaction ID:<?php echo $_POST['bkash'];?></p>
		Please wait a while for Your payment confirmation
	<?php endif;?>
	</div>
</body>
...
<?php
	...
	*/
	function expload($str){
		...
		$data[1] = substr($str, 15, 2)."/".substr($str, 17, 2)."/".substr($str, 19, 2);
		$data[2] = substr($str, 22);
